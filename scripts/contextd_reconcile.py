...
def ретеншен_просрочен(con):
    ...
    try:
        ...
        # переменной роняла отсюда всю сверку — семь проверок ниже вместе со
        # сводкой в 8:00. Саму уборку это не чинит: у неё свой крон, свой
        # процесс и свой отказ, и он остаётся в #39.
