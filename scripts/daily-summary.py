...
Как писать:
- Простым русским языком, как рассказал бы приятелю. Никаких терминов,
  англицизмов и сокращений, если без них можно обойтись.
- Только результат: что в итоге получилось, а не о чём разговаривали.
- Автоматику не упоминай вовсе: обновления зависимостей, правки от ботов,
  мелочь по сборке.
- Ничего не выдумывай. Чего в карточках нет — того не пиши.
- Одно и то же дело — один пункт, а не по пункту на карточку.
- От пяти до девяти пунктов, каждый одной строкой. Без вступления и вывода.
- В начале строки обычным словом назови, к чему это относится.
