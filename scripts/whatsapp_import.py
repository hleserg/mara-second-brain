...
def self_check():
    ...
    пробел = list(events(parse(["02.09.26, 14:05 - Анна: ок  ок",
                                "02.09.26, 14:05 - Анна: ок ок"], tz=tz), "Анна"))
    assert пробел[0]["source_id"] != пробел[1]["source_id"], \
        "счёт повторов идёт по нормализованному тексту, иначе ключ всё равно один"
