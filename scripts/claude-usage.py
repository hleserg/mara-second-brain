...
def self_check():
    ...
    # Пустая переменная уводит к файлу — это и значит «не задано». Проверять
    # её с настоящим путём нельзя: на машине, где файл есть, самопроверка
    # зависела бы от настройки машины, а не от кода.
