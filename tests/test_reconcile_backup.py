...
class БэкапЯдра(unittest.TestCase):
    ...
    def test_порог_читается_из_окружения(self):
        ...
        try:
            ...
            # В finally, а не после ассертов: осевшая в глобальном списке
            # жалоба красит все остальные тесты модуля, и одна настоящая
            # поломка превращается в тринадцать.
            del rc.ОШИБКИ_КОНФИГА[было:]
