...
# Адрес туннеля в тайлнете. В публичном репозитории его нет: реальный
# ставится переменной в ~/.hermes/.env рядом с MARA_CONTEXT_TOKEN.
URL = os.environ.get("MARA_CONTEXT_URL", "http://100.64.0.1:8788")
